...
-(void) loadFilters {
    for(int i = 0; i < 10; i++) {
        ...
        button.layer.cornerRadius = kFilterRadius;
        ...
        UIBezierPath *bi = [UIBezierPath bezierPathWithRoundedRect:button.bounds
                                                 byRoundingCorners:UIRectCornerAllCorners
                                                       cornerRadii:CGSizeMake(kFilterRadius, kFilterRadius)];
...
-(void)captureImage {
    ...
    void (^completion)(UIImage *, NSError *) = ^(UIImage *img, NSError *error) {
        ...
        [self.photoCaptureButton setTitle:@"저장" forState:UIControlStateNormal];
        [self.photoCaptureButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [self.photoCaptureButton setBackgroundImage:nil forState:UIControlStateNormal];
...
-(IBAction) retakePhoto:(UIButton *)button {
    ...
    [self.photoCaptureButton setBackgroundImage:[UIImage imageNamed:@"camera"] forState:UIControlStateNormal];
